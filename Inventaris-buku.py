...
def addtoexcel(namabuku, penulis, penerbit, tahunterbit):
    wb = load_workbook(filename='D:\Kuliah\Semester 2\Struktur Data\database.xlsx')
    wb.active
    sheet = wb['InputBuku']
    wb.save(filename='D:\Kuliah\Semester 2\Struktur Data\database.xlsx')
    x = 2
    while True:
...
def outofexcel(namabuku, penulis, penerbit, tahunterbit):
    wb2 = load_workbook(filename='D:\Kuliah\Semester 2\Struktur Data\database.xlsx')
    wb2.active
    sheet = wb2['OutputBuku']
    wb2.save(filename='D:\Kuliah\Semester 2\Struktur Data\database.xlsx')
    y = 2
    while True:
